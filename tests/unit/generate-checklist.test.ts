...
describe("generateChecklist", () => {
  it("generates command scenarios for command-related tasks", () => {
    const checklist = generateChecklist([{ title: "Ajouter commande /monitor" }]);
  ...
  it("generates multiple scenarios for complex tasks", () => {
    const checklist = generateChecklist([{ title: "Deploy avec monitoring et alertes" }]);
