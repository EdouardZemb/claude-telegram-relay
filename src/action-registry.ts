...
const ACTIONS: ActionDefinition[] = [
  ...
  // ─── planning.ts ───
  {
    ...
    params: [{ name: "request", required: true, description: "Description de ce que tu veux realiser" }],
    risk: "medium",
    module: "planning",
    requiresSupabase: true,
  ...
  },
  {
    ...
    params: [{ name: "input", required: false, description: "Description pour creer, ou ID pour voir" }],
    risk: "medium",
    module: "planning",
    requiresSupabase: true,
  ...
  // ─── utilities.ts ───
  {
    ...
    usage: "/speak [texte]",
    params: [{ name: "text", required: false, description: "Texte a synthetiser (ou dernier message)" }],
    risk: "low",
    module: "utilities",
    requiresSupabase: false,
