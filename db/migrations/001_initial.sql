...
-- Required extensions
-- CREATE EXTENSION IF NOT EXISTS vector; -- Managed by Supabase dashboard
-- CREATE EXTENSION IF NOT EXISTS pg_net; -- Managed by Supabase dashboard
...
-- ============================================================
-- GITHUB ENTITY MAP TABLE (GitHub sync idempotency)
-- ============================================================
-- Maps pipeline runs/phases to GitHub issues for unidirectional sync.
-- Enables idempotent push operations and crash recovery.
